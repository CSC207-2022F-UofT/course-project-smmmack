...
public class InputMap {
    ...
    /**
     * Appendix are input maps that adds to the commands specified in the input map. typically, its for commands that
     * can be called anytime, so that we dont need to write these commands in every input map.
     */
